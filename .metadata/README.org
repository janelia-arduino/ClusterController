...
| power-off-all-prisms | '<BB'          |             0x01 |           0x07 |               |       |       |       0x07 | '<B'            |
| power-on-all-prisms  | '<BB'          |             0x01 |           0x08 |               |       |       |       0x08 | '<B'            |
| home-prism           | '<BBB'         |             0x01 |           0x09 | prism-address |       |       |       0x09 | '<B'            |
| home-all-prisms      | '<BB'          |             0x01 |           0x0A |               |       |       |       0x0A | '<B'            |
