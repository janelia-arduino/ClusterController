...
| home                       | '<BBBBHb'      |              7 |           0x09 | prism-address, travel-limit-mm, stall-threshold | '<BBBB'         |               4 | prism-address          |
| home-all                   | '<BBBHb'       |              6 |           0x0A | travel-limit-mm, stall-threshold                | '<BBB'          |               3 |                        |
| all-homed                  | '<BBB'         |              3 |           0x0B |                                                 |                 |                 |                        |
| write-target-position      | '<BBBBH'       |              6 |           0x0C | prism-address, position-mm                      | '<BBBB'         |               4 | prism-address          |
| write-all-target-positions | '<BBBHHHHHHH'  |             17 |           0x0D | position-mm[prism-count]                        | '<BBB'          |               3 |                        |
| pause                      | '<BBBB'        |              4 |           0x0E | prism-address                                   | '<BBBB'         |               4 | prism-address          |
| pause-all                  | '<BBB'         |              3 |           0x0F |                                                 | '<BBB'          |               3 |                        |
