//$file${./ClusterControl~::Prism.cpp} vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv
//
...
//$define${Shared::Prism_getInstance} vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv
namespace CC {
...
//$define${AOs::Prism} vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv
namespace CC {
...
Q_STATE_DEF(Prism, Homing) {
    ...
    switch (e->sig) {
        ...
        case CLUSTER_TIMEOUT_SIG: {
            FSP::Prism_checkHome(this, e);
            //${AOs::Prism::SM::PoweredOn::SetupAndCommunic~::Homing::CLUSTER_TIMEOUT::[homeSucceeded]}
            if (FSP::Prism_homeSucceeded(this, e)) {
                status_ = Q_RET_HANDLED;
            }
            //${AOs::Prism::SM::PoweredOn::SetupAndCommunic~::Homing::CLUSTER_TIMEOUT::[homeFailed]}
            else if (FSP::Prism_homeFailed(this, e)) {
                status_ = tran(&Homing);
            }
            //${AOs::Prism::SM::PoweredOn::SetupAndCommunic~::Homing::CLUSTER_TIMEOUT::[else]}
            else {
                status_ = Q_RET_HANDLED;
            }
            break;
